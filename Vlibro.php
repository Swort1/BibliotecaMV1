		...
		<div id="DatosLi">
			...
			<div id="tablaLi">
				...
				<div id="busqueda">
					...
					<button onclick="VistaDetalleAutor();">Preferencia de Autor</button>
					<button onclick="VistaDetalleEditorial();">Preferencia de Editorial</button>
					<button onclick="VistaDetalleGenero();">Preferencia de Género</button>
					</div>	
